...
const AdminBooksPage = () => {
  ...
  const handleUpdate = async (id) => {
    try {
      ...
      await axios.put(`${API_URL}/books/${id}`, cleaned);
      setEditId(null);
      setEditData({
        title: "",
        author: "",
  ...
  if (loading) {
    return <p className="text-center text-gray-400 mt-20">Loading books...</p>;
  }
              ...
              {editId === book.id ? (
                <div className="flex flex-col sm:flex-row gap-2 w-full">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditData({ ...editData, genre_id: e.target.value })
                    }
                    className="p-2 rounded-lg bg-[#3a3636] text-white"
                  >
                    <option value="">Select genre</option>
